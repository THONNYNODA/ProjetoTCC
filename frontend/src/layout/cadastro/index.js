...
const validationSchema = yup.object({
  ...
  email:yup.string().email("Email nao e valido").required("Campo e obrigatorio"),
  ...
  dsSenha:yup.string().min(8, "No minimo 8 characteres").required("Campo e obrigatorio"),
  dsSenhaCon:yup.string().oneOf([yup.ref("dsSenha")], "A senha nao confirma").required("Campo e obrigatorio")
});
              ...
              {erro}
                 <form className={classes.formSize} onSubmit={formik.handleSubmit} > 
                  ...
                  <BoxForm>
                   ...
                   <InputForm> 
                     ...
                     helperText={formik.touched.dtNascimento && formik.errors.dtNascimento}              
                      />                                          
                   </InputForm>
                   <InputForm>                  
                     <FormControl
                      ...
                      >               
                        ...
                        { listas.sort((a, b) => a.nmFuncao > b.nmFuncao ? 1 : -1).map(e => <MenuItem value={e._id} key={e._id} >{e.nmFuncao}</MenuItem>)}
                      </TextField>         
                     </FormControl>               
                   </InputForm> 
                 </BoxForm>
                 ...
                 <BoxForm>
                  ...
                  <InputForm>                           
                    ...
                    onChange={formik.handleChange}
                    error={formik.touched.dsSenhaCon && Boolean(formik.errors.dsSenhaCon)}
                    helperText={formik.touched.dsSenhaCon && formik.errors.dsSenhaCon}
                    />
                  </InputForm>              
                 </BoxForm>
